...
class DashedBorder extends Border {
  ...
  const DashedBorder.fromBorderSide(StyledBorderSide side)
      : this(
          top: side,
          right: side,
          bottom: side,
  ...
  factory DashedBorder.all({
    ...
    return DashedBorder.fromBorderSide(side);
  }
  ...
  bool get _gradientIsUniform {
    final topGradient = top.dashStyle;
    return left.dashStyle == topGradient &&
        bottom.dashStyle == topGradient &&
        right.dashStyle == topGradient;
  }
...
void _paintNonUniformBorder(
  ...
  required StyledBorderSide left,
  required StyledBorderSide top,
  required StyledBorderSide right,
  required StyledBorderSide bottom,
}) {
